...
//    shapeManager.addShape(cb);
//
//    mStatusBar->showMessage("Cuboid created - Click Save to view in 3D");
//    QMessageBox::information(this, "Success", "Cuboid created. Click 'Save' to render in 3D viewer.");
//}
//
//void Sketcher3D::onCubeToolClicked()
//{
...
//    shapeManager.addShape(c);
//
//    mStatusBar->showMessage("Cube created - Click Save to view in 3D");
//    QMessageBox::information(this, "Success", "Cube created. Click 'Save' to render in 3D viewer.");
//}
//
//void Sketcher3D::onPyramidClicked()
//{
...
//    shapeManager.addShape(py);
//
//    mStatusBar->showMessage("Pyramid created - Click Save to view in 3D");
//    QMessageBox::information(this, "Success", "Pyramid created. Click 'Save' to render in 3D viewer.");
//}
//
//void Sketcher3D::onCylinderToolClicked()
//{
...
//    shapeManager.addShape(cyl);
//
//    mStatusBar->showMessage("Cylinder created - Click Save to view in 3D");
//    QMessageBox::information(this, "Success", "Cylinder created. Click 'Save' to render in 3D viewer.");
//}
//
//void Sketcher3D::onConeToolClicked()
//{
...
//    shapeManager.addShape(cone);
//
//    mStatusBar->showMessage("Cone created - Click Save to view in 3D");
//    QMessageBox::information(this, "Success", "Cone created. Click 'Save' to render in 3D viewer.");
//}
//
//void Sketcher3D::onSphereToolClicked()
//{
...
//    shapeManager.addShape(sp);
//
//    mStatusBar->showMessage("Sphere created - Click Save to view in 3D");
//    QMessageBox::information(this, "Success", "Sphere created. Click 'Save' to render in 3D viewer.");
//}
//
//void Sketcher3D::onSaveGNUActionTriggered()
//{
...
//        glWidget->loadDATFile(qFileName);
//        mStatusBar->showMessage("Shapes saved and loaded into 3D viewer!");
//        // ============================================
//
...
//        {
//            // ============= LOAD INTO OPENGL =============
//            QString qFileName = QString::fromStdString(datFileName);
//            glWidget->loadDATFile(qFileName);
//            mStatusBar->showMessage("Shapes saved and loaded into 3D viewer!");
//            // ============================================
//        }
...
void Sketcher3D::setupUI()
{
    ...
    // ============= CREATE OPENGL WIDGET =============
    glWidget = new GLWidget(this);
    glWidget->setMinimumSize(900, 700);

    // Add OpenGL widget to the central grid layout
    mCentralgridWidget->addWidget(glWidget, 0, 0, 1, 2);  // Span 2 columns
    // ================================================
    ...
    mStatusBar = std::make_unique<QStatusBar>(this);
    setStatusBar(mStatusBar.get());
    mStatusBar->showMessage("3D Viewer Ready - Triangle-Based Rendering Enabled");
...
void Sketcher3D::setupViewControls()
{
    // Create a widget for view controls
    QWidget* controlWidget = new QWidget(this);
    QHBoxLayout* controlLayout = new QHBoxLayout(controlWidget);

    // Label
    mViewLabel = std::make_unique<QLabel>("View Options:", controlWidget);
    controlLayout->addWidget(mViewLabel.get());

    // Wireframe checkbox
    mWireframeCheckBox = std::make_unique<QCheckBox>("Wireframe", controlWidget);
    mWireframeCheckBox->setChecked(false);
    connect(mWireframeCheckBox.get(), &QCheckBox::toggled, this, &Sketcher3D::onWireframeToggled);
    controlLayout->addWidget(mWireframeCheckBox.get());

    // Show axes checkbox
    mShowAxesCheckBox = std::make_unique<QCheckBox>("Show Axes", controlWidget);
    mShowAxesCheckBox->setChecked(true);
    connect(mShowAxesCheckBox.get(), &QCheckBox::toggled, this, &Sketcher3D::onShowAxesToggled);
    controlLayout->addWidget(mShowAxesCheckBox.get());

    controlLayout->addStretch();

    // Add to main layout (below OpenGL widget)
    mCentralgridWidget->addWidget(controlWidget, 1, 0, 1, 2);
}

// NEW: Wireframe toggle handler
void Sketcher3D::onWireframeToggled(bool checked)
{
    glWidget->setWireframeMode(checked);
    mStatusBar->showMessage(checked ? "Wireframe Mode Enabled" : "Solid Mode Enabled");
}

// NEW: Show axes toggle handler
void Sketcher3D::onShowAxesToggled(bool checked)
{
    glWidget->setShowAxes(checked);
    mStatusBar->showMessage(checked ? "Axes Visible" : "Axes Hidden");
}
